...
func (x *UpadteUserInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpadteUserInfo) ProtoMessage() {}

func (x *UpadteUserInfo) ProtoReflect() protoreflect.Message {
	mi := &file_user_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpadteUserInfo.ProtoReflect.Descriptor instead.
func (*UpadteUserInfo) Descriptor() ([]byte, []int) {
	return file_user_proto_rawDescGZIP(), []int{6}
}

func (x *UpadteUserInfo) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *UpadteUserInfo) GetNickName() string {
	if x != nil {
		return x.NickName
	}
	return ""
...
func (x *UpadteUserInfo) GetGender() string {
	if x != nil {
		return x.Gender
	}
	return ""
...
func (x *UpadteUserInfo) GetBirthday() int64 {
	if x != nil {
		return x.Birthday
	}
	return 0
...
var file_user_proto_rawDesc = []byte{
	...
	0x0e, 0x55, 0x70, 0x61, 0x64, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x12,
	...
	0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x62, 0x69, 0x72, 0x74, 0x68, 0x64, 0x61, 0x79, 0x22,
	...
	0x18, 0x07, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x22, 0x4f, 0x0a, 0x10,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0xb1, 0x02,
	...
	0x6e, 0x73, 0x65, 0x12, 0x32, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x4d, 0x6f,
	...
	0x73, 0x65, 0x72, 0x12, 0x0f, 0x2e, 0x55, 0x70, 0x61, 0x64, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72,
...
var file_user_proto_goTypes = []interface{}{
	...
	(*UpadteUserInfo)(nil),    // 6: UpadteUserInfo
...
var file_user_proto_depIdxs = []int32{
	...
	6, // 5: User.UpdateUser:input_type -> UpadteUserInfo
...
type UserClient interface {
	...
	UpdateUser(ctx context.Context, in *UpadteUserInfo, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *userClient) UpdateUser(ctx context.Context, in *UpadteUserInfo, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type UserServer interface {
	...
	UpdateUser(context.Context, *UpadteUserInfo) (*empty.Empty, error)
...
func (*UnimplementedUserServer) UpdateUser(context.Context, *UpadteUserInfo) (*empty.Empty, error) {
...
func _User_UpdateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).UpdateUser(ctx, req.(*UpadteUserInfo))
	}
	return interceptor(ctx, in, info, handler)
}
